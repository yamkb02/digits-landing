...
import { fadeInUp, fadeInLeft, fadeInRight, scaleIn } from '@/lib/hooks/useScrollAnimation'

export default function HeroSection() {
  return (
    <div id="home" className="w-full bg-gradient-to-br from-orange-50 via-white to-orange-50 pt-32 pb-20 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-40">
        <div className="absolute inset-0 bg-gradient-to-r from-orange/10 to-orange/5"></div>
      </div>
      
      <div className="max-w-7xl mx-auto text-center relative z-10 max-w-full">
