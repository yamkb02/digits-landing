...
export default function InventoryDashboard() {
  const inventoryItems = [
    {
      inventoryNo: "INV-001",
      itemDescription: "All Purpose Flour 25kg",
      itemCode: "APF-25KG",
      uom: "sack",
      price: "₱850.00",
      qty: 45,
      totalValue: "₱38,250.00",
      location: "Warehouse A",
    },
    {
      inventoryNo: "INV-002",
      itemDescription: "Premium Butter 500g",
      itemCode: "BUT-500G",
      uom: "piece",
      price: "₱320.00",
      qty: 28,
    ...
    {
      inventoryNo: "INV-004",
      itemDescription: "Brown Sugar 1kg",
      itemCode: "BS-1KG",
      uom: "kg",
      price: "₱95.00",
      qty: 52,
    ...
    {
      inventoryNo: "INV-005",
      itemDescription: "Vanilla Extract 100ml",
      itemCode: "VE-100ML",
      uom: "bottle",
      price: "₱185.00",
      qty: 18,
    ...
    {
      inventoryNo: "INV-006",
      itemDescription: "Baking Powder 500g",
      itemCode: "BP-500G",
      uom: "can",
      price: "₱125.00",
      qty: 24,
    ...
    {
      inventoryNo: "INV-007",
      itemDescription: "Cocoa Powder 1kg",
      itemCode: "CP-1KG",
      uom: "kg",
      price: "₱420.00",
      qty: 15,
    ...
    {
      inventoryNo: "INV-008",
      itemDescription: "Instant Yeast 500g",
      itemCode: "IY-500G",
      uom: "pack",
      price: "₱275.00",
      qty: 32,
    ...
    {
      inventoryNo: "INV-012",
      itemDescription: "Almond Flour 1kg",
      itemCode: "AF-1KG",
      uom: "kg",
      price: "₱680.00",
      qty: 12,
