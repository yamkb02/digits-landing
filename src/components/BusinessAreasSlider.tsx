...
const sliderData = [
  {
    ...
    description: 'Streamline your procurement process with intelligent supplier management and automated purchase orders.',
    icon: '🛒',
  ...
  },
  {
    ...
    description: 'Comprehensive sales tracking with advanced analytics to boost revenue and customer satisfaction.',
    icon: '📊',
  ...
  },
  {
    ...
    description: 'Real-time inventory tracking with predictive analytics to optimize stock levels and reduce waste.',
    icon: '📦',
  ...
  },
  {
    ...
    description: 'Complete financial oversight with automated reporting and real-time cash flow monitoring.',
    icon: '💰',
